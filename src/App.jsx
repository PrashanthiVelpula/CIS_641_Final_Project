    ...
    <ThemeProvider>
      <Router>
        <Routes>
          ...
          <Route
            path="/"
            element={!isLoggedIn ? <Login onLogin={handleLogin} /> : <Navigate to="/item-categories" />}
          />
          <Route path="/create-account" element={<CreateAccount />} />
          <Route path="/account_success" element={<Success />} />
              ...
              element={
                <Layout isLoggedIn={isLoggedIn} onLogout={handleLogout}>
                  <Routes>
                    ...
                    <Route path="/add-item-categories" element={<AddCategory />} />
                    <Route path="/item-types/:category" element={<ItemTypes />} />
                    <Route path="/add-item-type/:category" element={<AddItemType />} />
                    <Route path="/details/:category/:item" element={<Details />} />
                    <Route path="/editdetails/:category/:itemId" element={<EditDetails />} />
                    <Route path="/inventory" element={<InventoryCounter />} />
                  </Routes>
                </Layout>
